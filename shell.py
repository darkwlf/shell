...
"""
developer: dark-wolf.
email:drk.wlf9@gmail.com.
telegram:telegram.me/linuxlover_programmer.
discord:darkwlf#2305.
just dont copy source code please.
good luck :)
"""
###############################
...
while True:
   ...
   if a.startswith("echo "):
      ...
      print(f"your system shutdown at {a[9:]} seconds later\nfor cancel shutdown proccesss type cancel command")
   elif a.startswith("reboot "):
      restart(time=a[7:],force=False)
      print(f"your system restart at {a[7:]} seconds later\nfor cancel please write cancel command")
   elif a == "cancel":
      cancel()
